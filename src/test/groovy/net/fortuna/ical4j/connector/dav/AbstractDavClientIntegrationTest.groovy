...
import static net.fortuna.ical4j.connector.dav.property.BaseDavPropertyName.CURRENT_USER_PRINCIPAL
import static net.fortuna.ical4j.connector.dav.property.BaseDavPropertyName.SUPPORTED_REPORT_SET
import static net.fortuna.ical4j.connector.dav.property.CalDavPropertyName.*
import static net.fortuna.ical4j.connector.dav.property.CardDavPropertyName.ADDRESSBOOK_HOME_SET
